...
// import hu.icellmobilsoft.atr.sample.rest.ILoadData;
...
// public class SamplePatientAction extends LoadDataImpl{
public class SamplePatientAction extends RequestDataImpl {
    ...
    // JSONObject departments = (JSONObject) ((JSONObject)
    // institute.get(i)).get("departments");
    ...
    // tempInst.addDepartments(new Department(depId,
    // this.depRep.findDepartment(depId).getName()));
    // }
    // } else {
    ...
    // patient.get(i)).get("department").toString();
